...
public class TestEmployee {
    public static void main(String[] args) {
        ...
        EmployeeFullTime e2 = new EmployeeFullTime(2, "Quan", 29, "09930046", "quan@gmai.com", 300000.0, 500000.0, 9000000.0);
        EmployeeFullTime e3 = new EmployeeFullTime(3, "Luong", 23, "09428476", "luong@gmai.com", 500000.0, 800000.0, 1100000.0);

        EmployeePartTime e4 = new EmployeePartTime(4, "Phong", 22, "04884993", "Phong@gmail.com", 15);
        EmployeePartTime e5 = new EmployeePartTime(5, "Hai", 23, "09488377", "hai@gmail.com", 26);
        EmployeePartTime e6 = new EmployeePartTime(6, "Tuan", 27, "0454543", "tuan@gmail.com", 25);
